...
//acciones
export const verificarTokenAccion = (token: string) => async (dispatch: any, getState: any) => {
...
export const cambiarPasswordAccion = (medico: IMedico) => async (dispatch: any, getState: any) => {
    console.log(medico)
