...
import { verificarTokenAccion, cambiarPasswordAccion, INewPassword } from '@/redux/newPasswordDuck'
...
const NewPassword = () => {
    ...
    const state: INewPassword = useSelector((state: any) => state.newPassword)
    ...
    const token: string = new URLSearchParams(useLocation().search).get('token') || '';
    ...
    return (
        <div className="container h-100">
            ...
            <div className="row justify-content-center">
                <Paper 
                elevation={3}
                className="border pt-3 col-12 col-md-8 col-lg-8 text-center">
