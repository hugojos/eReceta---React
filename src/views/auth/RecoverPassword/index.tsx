...
import { enviarLinkAccion, resetearAccion, IRecoverPassword } from '@/redux/recoverPasswordDuck'
...
const RecoverPassword = () => {
    ...
    const { enviado, loading, errorResponse }: IRecoverPassword = useSelector((state: any) => state.recoverPassword)
        ...
        <div className="container h-100">
            <div className="row justify-content-center">
                ...
                {   !enviado ?
                    ...
                    className="text-left col-12 col-lg-8 pt-3">
