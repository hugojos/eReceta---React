...
import { modificarMedicoAccion, traerDatosMedico, resetearMedicoAccion, IModificarDatos } from '@/redux/modificarDatosDuck'
...
const Profile = () => {
    ...
    const state: IModificarDatos = useSelector((state: any) => state.modificarDatos)

    const [openFirmar, setOpenFirmar] = useState<boolean>(false)
    ...
    const handleInputMedicoChange = (event: any) => {
    ...
    const handleMedicoFirma = (value: string): void => {
        setMedico({
            ...medico,
                ...
                <div className="col-12 col-md-6">
                    ...
                    className="p-2">
                        ...
                        {   !Object.keys(state.datos).length ?
                            ...
                            <div style={{backgroundColor: modificar ? 'rgba(206, 206, 206, 0.151)': 'inherit'}} className={modificar ? 'border p-3':''}>
